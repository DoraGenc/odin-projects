  ...
  best_days = [0, 0]
    ...
    stock_prices.each_with_index do |buy_price, buy_day_index|
      stock_prices.each_with_index do |sell_price, sell_day_index|
        ...
        if sell_day_index > buy_day_index
...
user_stockprices = Array.new


weekdays = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"] #konstante
...
weekdays.each do |day|
  ...
  while !valid_input #Die Schleife fragt so lange den gleichen Tag ab, bis die Eingabe valid ist
    puts "#{day}: "
